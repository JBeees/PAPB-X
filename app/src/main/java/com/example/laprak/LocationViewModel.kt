...
//                    LocationState.Error("Lokasi tidak ditemukan. Pastikan GPS aktif.")
                requestCurrentLocation(fusedLocationClient)
            }
    ...
    @Suppress("MissingPermission")
    private fun requestCurrentLocation(fusedLocationClient: FusedLocationProviderClient) {
